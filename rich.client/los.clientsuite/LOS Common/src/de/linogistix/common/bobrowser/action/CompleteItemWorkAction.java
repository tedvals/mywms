...
import de.linogistix.common.bobrowser.crud.gui.component.CompleteItemWorkWizard;
...
public class CompleteItemWorkAction extends NodeAction {

    private static final Logger log = Logger.getLogger(CompleteItemWorkAction.class.getName());
    ...
    protected void performAction(Node[] node) {
	    ...
	    CompleteItemWorkWizard w = new CompleteItemWorkWizard(bo);
    ...
    public String getName() {
        return NbBundle.getMessage(CommonBundleResolver.class, "compWork");
    }
