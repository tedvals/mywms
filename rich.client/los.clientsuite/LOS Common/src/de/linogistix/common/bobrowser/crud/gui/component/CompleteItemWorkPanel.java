...
final public class CompleteItemWorkPanel implements Panel{
  
  private CompleteItemWorkWizard wizard;
  
  private CompleteItemWorkJPanel ui;
  ...
  private CompleteItemWorkJPanel getPanelUI() {
    if (ui == null) {
        ui = new CompleteItemWorkJPanel(this.wizard.getBo());
    }
    return ui;
  }
  ...
  public void readSettings(Object settings) {
    this.wizard = (CompleteItemWorkWizard)settings;
