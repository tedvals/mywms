...
final public class CompleteVehicleWorkPanel implements Panel{
  
  private CompleteVehicleWorkWizard wizard;
  
  private CompleteVehicleWorkJPanel ui;
  ...
  private CompleteVehicleWorkJPanel getPanelUI() {
    if (ui == null) {
        ui = new CompleteVehicleWorkJPanel(this.wizard.getBo());
    }
    return ui;
  }
  ...
  public void readSettings(Object settings) {
    this.wizard = (CompleteVehicleWorkWizard)settings;
