...
public class BOLOSStorageRequestMasterNode extends BOMasterNode {
    ...
    public PropertySet[] getPropertySets() {
        ...
        if (sheet == null) {
            ...
            BOMasterNodeProperty<String> requestState = new BOMasterNodeProperty<String>("requestState", String.class, "LOSStorageRequestState." + to.getRequestState(), InventoryBundleResolver.class, true);
    ...
    public static Property[] boMasterNodeProperties() {
        ...
        BOMasterNodeProperty<String> requestState = new BOMasterNodeProperty<String>("requestState", String.class, "", InventoryBundleResolver.class);
