 ...
 */
final public class ChangeAmountInfoPanel implements WizardDescriptor.ValidatingPanel, PropertyChangeListener, WizardDescriptor.FinishablePanel {

    private BOStockUnitChangeAmountWizard wizard;
    private ChangeAmountInfoPanelUI ui;
    private boolean finishPanel = true;
    /** listener to changes in the wizard */
    private ChangeListener listener;

    private ChangeAmountInfoPanelUI getPanelUI() {
        if (ui == null) {
            ui = new ChangeAmountInfoPanelUI();
        }
        return ui;
    }
