...
public class TreatOrderDialogModel {
    ...
    private BODTO<LOSOrderRequestPosition> actuOrderPos;
    ...
    public void setActuOrderPosition(BODTO<LOSOrderRequestPosition> orderPos, BigDecimal amountToPick){
...
//        }
    ...
    public List<BODTO<LOSOrderRequestPosition>> getHandledPositions(){
        
        Set<Long> orderPosIdSet = orderPosMap.keySet();
               
        List<BODTO<LOSOrderRequestPosition>> handledPosList;
        handledPosList = new ArrayList<BODTO<LOSOrderRequestPosition>>(orderPosIdSet.size());
