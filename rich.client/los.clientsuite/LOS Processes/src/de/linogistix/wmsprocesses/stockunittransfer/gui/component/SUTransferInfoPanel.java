 ...
 */
final public class SUTransferInfoPanel implements WizardDescriptor.ValidatingPanel, PropertyChangeListener, WizardDescriptor.FinishablePanel {

    private BOStockUnitTransferWizard wizard;
    private SUTransferInfoPanelUI ui;
    private boolean finishPanel = true;
    /** listener to changes in the wizard */
    private ChangeListener listener;

    private SUTransferInfoPanelUI getPanelUI() {
        if (ui == null) {
            ui = new SUTransferInfoPanelUI();
        }
        return ui;
    }
