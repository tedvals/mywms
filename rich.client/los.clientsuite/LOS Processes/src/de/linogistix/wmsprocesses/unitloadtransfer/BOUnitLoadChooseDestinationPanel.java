...
import de.linogistix.wmsprocesses.unitloadtransfer.component.ChooseDestinationPanel;
 ...
 */
final public class BOUnitLoadChooseDestinationPanel implements WizardDescriptor.ValidatingPanel, PropertyChangeListener, WizardDescriptor.FinishablePanel {

    private BOUnitLoadTransferWizard wizard;
    private ChooseDestinationPanel ui;
    private boolean finishPanel = true;
    /** listener to changes in the wizard */
    private ChangeListener listener;
            
    private ChooseDestinationPanel getPanelUI() {
        if (ui == null) {
            ui = new ChooseDestinationPanel();
            ...
            ui.getUnitLoadAutoFilteringComboBox().addItemChangeListener(new PropertyChangeListener() {
                ...
                public void propertyChange(PropertyChangeEvent evt) {
                    ...
                    getPanelUI().getSourceField().setText("");
                    if (getPanelUI().getUnitLoadAutoFilteringComboBox().getSelectedItem() != null) {
                        wizard.setUnitLoadTO((BODTO<LOSUnitLoad>) getPanelUI().getUnitLoadAutoFilteringComboBox().getSelectedItem());
                        getPanelUI().getSourceField().setText(getPanelUI().getUnitLoadAutoFilteringComboBox().getSelectedAsEntity().getStorageLocation().getName());
...
//            
            ...
            try {
                mangeLoc.checkUnitLoadSuitable(sl, ul);
    ...
    public void readSettings(Object settings) {
        ...
        if (this.wizard.getUnitLoadTO() != null) {
            getPanelUI().getUnitLoadAutoFilteringComboBox().getAutoFilteringComboBox().addItem(wizard.getUnitLoadTO().getName());
        }
        if (this.wizard.getStorageLocationTO() != null) {
            getPanelUI().getDestinationAutofilteringComboBox().getAutoFilteringComboBox().addItem(wizard.getStorageLocationTO().getName());
        }
