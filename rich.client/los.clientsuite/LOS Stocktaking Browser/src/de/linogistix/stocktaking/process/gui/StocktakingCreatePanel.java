...
public class StocktakingCreatePanel extends JPanel {
    ...
    private void initComponents() {
        ...
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        centerPanel1.add(enableEmptyLocations, gridBagConstraints);

        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        centerPanel1.add(enableFullLocations, gridBagConstraints);
    ...
    protected void processCreate() {
        ...
        try {
            ...
            int numOrders = 0;
            numOrders = stFacade.generateOrders(false, clientId, areaId, zoneId, rackId, locationId, locationName, itemId, itemNo, invDate, enableEmptyLocations.isSelected(), enableFullLocations.isSelected() );
            ...
            numOrders = stFacade.generateOrders(true, clientId, areaId, zoneId, rackId, locationId, locationName, itemId, itemNo, invDate, enableEmptyLocations.isSelected(), enableFullLocations.isSelected() );
