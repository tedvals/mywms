...
public enum WorkItemCompletionStatus implements WorkItemComplete{
	...
	WorkItemCompletionStatus(boolean status){
		this.status = status;
	}
	...
	public static WorkItemComplete resolve(boolean status){
		if(status==true)
		return SUCCESSFUL;
		else
