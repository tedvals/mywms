...
@Stateless
public class VehicleDataQueryBean extends BusinessObjectQueryBean<VehicleData> implements VehicleDataQueryRemote {

    private static final Logger log = Logger.getLogger(VehicleDataQueryBean.class);
	...
	ret.add(id);
        ...
        TemplateQueryWhereToken chassisNumber = new TemplateQueryWhereToken(
            TemplateQueryWhereToken.OPERATOR_LIKE, "chassisNumber",
            value);
        ...
        TemplateQueryWhereToken engineNumber = new TemplateQueryWhereToken(
            TemplateQueryWhereToken.OPERATOR_LIKE, "engineNumber",
            value);
