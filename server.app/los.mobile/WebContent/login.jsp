            ...
            <form action='<%= response.encodeURL("/los-mobile/faces/login_redirect.jsp")%>' onsubmit="return checkInput()" method="POST" class="form">
                ...
                <div class="space">                    
                    ...
                    <table width="100%" style="padding-right:10px;" border="0" cellspacing="0" cellpadding="0"  >
                        <tr>
                            <td style="margin-left:5px"><h:outputLabel  id="loginLabel" for="loginTextField" value="#{bundle.User}" styleClass="label" /> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="50%" style="margin-left:5px"><h:outputLabel id="passwordLabel" for="passwordTextField" value="#{bundle.Password}" styleClass="label" /></td>
                        </tr>
                        <tr>
