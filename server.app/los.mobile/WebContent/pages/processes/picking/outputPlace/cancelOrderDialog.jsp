...
<html>
    ...
    <body>
        <f:view locale="#{OutputPlacePickingBean.locale}">
            <f:loadBundle var="bundle" basename ="de.linogistix.mobile.res.Bundle" /> 
                        ...
                        <tr>
                            <td colspan="2"><form name="form1" method="post" action="">
                                    <div align="center" style="padding-top:5px" >
                                        <h:commandButton id="cancelButton" value="#{bundle.Ok}" action="#{OutputPlacePickingBean.cancelPickingCanelDialogActionPerformedListener}" styleClass="commandButton"  />
                                    </div>
                            </td>
                        </tr>
                    </table>
